          ...
          <div className="svc-card" data-reveal style={{ marginTop: 14 }}>
            ...
            <div style={{ marginTop: 12 }}>
              <Feature
                ...
                desc={
                  lang === "az"
                    ? "Gündəlik statlar, funnel, conversion, team performansı."
                    : "Daily stats, funnels, conversion and team performance."
                }
              />
              <Feature
                ...
                desc={
                  lang === "az"
                    ? "Həftəlik təkmilləşdirmə: daha az manual iş, daha çox nəticə."
                    : "Weekly iteration: less manual work, more results."
                }
              />
              <Feature
                ...
                desc={
                  lang === "az"
                    ? "Rollar, audit izi, export, dəyişikliklərin izlənməsi."
                    : "Roles, audit trail, exports and change tracking."
                }
              />
            </div>
          </div>

...
// ✅ import et (səndə src/components/SmoothWheelScroll.tsx var)
...
const CONTACT_CSS = `
  ...
  /* ===== Scroll reveal (NO blur, NO heavy) ===== */
  .ct-reveal{
    opacity: 0;
  ...
  /* PREMIUM buttons: no underline, compact arrows removed */
  .ct-btn{
...
export default function Contact() {
  ...
  // ✅ Scroll reveal: 30% viewport-a girəndə aç
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      ...
      },
      {
        ...
        root: null,
        // elementin ~30%-i girəndə trigger üçün biraz da “buffer”
